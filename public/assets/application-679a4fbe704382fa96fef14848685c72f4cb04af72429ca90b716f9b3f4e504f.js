...
(function() {
  window.Facebook = (function() {
    ...
    Facebook.prototype.bindShareButton = function(selector, url) {
...
(function() {
  ...
  window.RegistrationPage = (function() {
    var bind_registration_popup;

    function RegistrationPage() {
      bind_registration_popup();
    }

    bind_registration_popup = function() {
      return $("#registration").click(function() {
        return $("#registrationModal").modal('show');
      });
    };
